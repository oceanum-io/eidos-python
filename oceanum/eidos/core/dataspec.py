...
class DataVars(EidosModel):
    attrs: Optional[Dict[constr(pattern=r'^.*$'), Union[str, float]]] = None
    """
...
class InlineDataset(EidosModel):
    ...
    """
    data_vars: Dict[constr(pattern=r'^[A-Za-z0-9_]*$'), DataVars]
    """
    Data variables
    """
    dims: Dict[constr(pattern=r'^.*$'), int]
    """
    Dimensions
    """
    coordkeys: Optional[Dict[constr(pattern=r'^[xyztg]$'), str]] = None
    """
